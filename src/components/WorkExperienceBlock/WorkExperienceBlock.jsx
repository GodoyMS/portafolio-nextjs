    ...
    <>
        ...
        <div className=" p-5 mt-4 rounded-lg bg-slate-800">
            ...
            <ol className="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
                ...
                <li>
                    <a href='https://monstruocreativo.com' target='_blank' className="items-center block p-3 sm:flex ">
                        <img className="w-12 h-12 mb-3 mr-3 rounded-full sm:mb-0" src="https://monstruocreativo.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsidebar-logo.1aed526b.png&w=128&q=75" alt="Monstruo Creativo"/>

                        <div className="text-gray-600 dark:text-gray-400">
                            <div className="text-base font-normal"><span className="font-medium text-gray-200">Monstruo Creativo</span></div>
                            <div className="text-sm font-normal text-gray-400">Full Stack React-Node developer </div>
                            <div className="text-xs font-normal text-gray-500 ml-4">Currentely developing    </div>
