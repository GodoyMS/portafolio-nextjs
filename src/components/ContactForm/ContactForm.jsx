...
const ContactForm = () => {
  ...
  return (
    ...
    <>
            ...
            {openToast && (<Toast message={'Message sent successfully, I will get in touch with you soon.'} isOpen={openToast} closeToast={handleCloseToast}/>)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <form  onSubmit={handleSubmit} className="p-6 flex flex-col justify-center">
                        ...
                        <div className="flex flex-col mt-2">
                            ...
                            <input required  type="email" value={email}  onChange={(prev)=>setEmail(prev.target.value)} name="user_email" id="email" placeholder="Email" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none" />
                        </div>

                        <div className="flex flex-col mt-2">
                            <label htmlFor="message" className="hidden">Message</label>
                            <textarea required rows={5}  onChange={(prev)=>setMessage(prev.target.value)} placeholder='Write your message' type="text" value={message} name="messsage" id="message" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none">
