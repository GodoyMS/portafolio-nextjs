...
const Toast = ({message,closeToast}) => {
  return (
    <div className=" max-w-xs mx-auto">
        ...
        <div class="ml-auto">
            <button onClick={closeToast} type="button" class="inline-flex flex-shrink-0 justify-center items-center h-8 w-8 text-black    rounded-md text-white/[.5]  transition-all text-sm  bg-[#fff]">
